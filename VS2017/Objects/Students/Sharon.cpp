...
void Sharon::setup() {
	...
	components[0]->translateModel(glm::translate(mat4(1.0f), vec3(-0.1f, 0.01f, 0.0f)));
	components[1]->translateModel(glm::translate(mat4(1.0f), vec3(0.1f, 0.0f, 0.0f)));

	mat4 initialDisplacement = glm::translate(mat4(1.0f), vec3(-0.75f, 0.0f, 0.75f));
	...
	(*&components[0]->topComponents[0]).updateChild(&components[1]->topComponents[3]);*/
}
