...
void LetterO::setup() { //create letter O
	components[0].concatWorldMatrix(glm::scale(mat4(1.0f), vec3(1.0f, 6.0f, 1.0f))   );
	//components[1].concatWorldMatrix( glm::translate(mat4(1.0f), vec3(-0.025f, 0.0f, 0.0f)) * glm::scale(mat4(1.0f), vec3(2.0f, 6.0f, 2.0f))  );
